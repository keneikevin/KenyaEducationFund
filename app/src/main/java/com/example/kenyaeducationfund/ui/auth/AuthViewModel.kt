...
import com.example.kenyaeducationfund.other.Constants.MAX_USER_NAME
import com.example.kenyaeducationfund.other.Constants.MIN_PASSWORD_LENGTH
...
class AuthViewModel @ViewModelInject constructor(
    ...
    fun register(email: String, username: String, password: String, repeatedPassword: String) {
        ...
        } else if(username.length < MIN_USER_NAME) {
            applicationContext.getString(R.string.error_username_too_short, MIN_USER_NAME)
        } else if(username.length > MAX_USER_NAME) {
            applicationContext.getString(R.string.error_username_too_long, MAX_USER_NAME)
